 ...
 */
package net.sf.jasperreports.samples.forms;
...
import net.sf.jasperreports.samples.forms.textinput.TextInputComponentCompiler;
import net.sf.jasperreports.samples.forms.textinput.TextInputComponentDesignConverter;
import net.sf.jasperreports.samples.forms.textinput.TextInputComponentDigester;
import net.sf.jasperreports.samples.forms.textinput.TextInputComponentFillFactory;
import net.sf.jasperreports.samples.forms.textinput.TextInputComponentManager;
		...
		ExtensionsRegistryFactory
{
	...
	public static final String XSD_RESOURCE = 
		"net/sf/jasperreports/samples/forms/forms.xsd";
