package net.sf.jasperreports.samples.datasource;
/*
...
public class CustomTableModel extends AbstractTableModel
{
	...
	public static JRDataSource createDataSourceInstance() {
		return new JRTableModelDataSource(new CustomTableModel());
	}
}
